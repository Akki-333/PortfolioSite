...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-40 bg-gradient-to-r from-sky-600 via-sky-500 to-sky-600 shadow-md border-b border-sky-400">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-sky-600 border-t border-sky-400">
            <div className="px-4 py-6 space-y-4">
              <button 
                onClick={() => handleNavClick("home")}
                className="block w-full text-left py-2 text-white/90 hover:text-white transition-colors"
