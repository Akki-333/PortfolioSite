        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed" data-testid="text-about-description-2">
              I bring expertise in troubleshootingAAAAABBBB, data analysis, and system development, with hands-on experience in Python, SQL, and Power BI. My passion lies in leveraging technology to solve real-world problems and create meaningful impact.
            </p>
